  ...
  async (
    ...
    try {
      ...
      if (serverRef.type === 'sse') {
        ...
        const finalCommand =
          process.env.WALIA_CODER_SHELL_PREFIX || serverRef.command
        const finalArgs = process.env.WALIA_CODER_SHELL_PREFIX
      ...
      const client = new Client(
        {
          ...
          description: "Walia Nexus's agentic coding tool",
