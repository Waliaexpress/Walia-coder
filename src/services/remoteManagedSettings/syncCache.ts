 ...
 *   WALIA_CODER_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via WALIA_CODER_OAUTH_TOKEN, CCR via
  // WALIA_CODER_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
