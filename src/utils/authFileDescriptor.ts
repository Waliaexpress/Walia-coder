 ...
 * rationale. Env var: WALIA_CODER_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'WALIA_CODER_OAUTH_TOKEN_FILE_DESCRIPTOR',
