 ...
 * @param teamName - Optional team name (defaults to WALIA_CODER_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's WALIA_CODER_AGENT_ID */
  workerId: string
  /** Worker's WALIA_CODER_AGENT_NAME */
  workerName: string
  /** Worker's WALIA_CODER_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to WALIA_CODER_TEAM_NAME env var)
