...
export const getGlobalClaudeFile = memoize((): string => {
  ...
  return join(process.env.WALIA_CONFIG_DIR || homedir(), filename)
})
 ...
 * If WALIA_CODER_HOST_PLATFORM is set to a valid platform value, that overrides
...
export function getHostPlatformForAnalytics(): Platform {
  const override = process.env.WALIA_CODER_HOST_PLATFORM
