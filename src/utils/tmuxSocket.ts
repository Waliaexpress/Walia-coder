...
async function doInitialize(): Promise<void> {
  ...
  // Pass WALIA_CODER_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'WALIA_CODER_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set WALIA_CODER_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  await execTmux([
    ...
    'set-environment',
    '-g',
    'WALIA_CODER_SKIP_PROMPT_HISTORY',
    'true',
  ])
