...
const TEAMMATE_ENV_VARS = [
  ...
  'WALIA_CODER_USE_BEDROCK',
  'WALIA_CODER_USE_VERTEX',
  'WALIA_CODER_USE_FOUNDRY',
  // Custom API endpoint
  'ANTHROPIC_BASE_URL',
 ...
 * Always includes CLAUDECODE=1 and WALIA_CODER_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'WALIA_CODER_EXPERIMENTAL_AGENT_TEAMS=1']
