 ...
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'WALIA_CODER_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'WALIA_CODER_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'WALIA_CODER_PLAN_MODE_REQUIRED'
