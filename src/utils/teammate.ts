...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.WALIA_CODER_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our WALIA_CODER_AGENT_ID matches the leadAgentId, OR
 *    - We have no WALIA_CODER_AGENT_ID set (backwards compat: the original
