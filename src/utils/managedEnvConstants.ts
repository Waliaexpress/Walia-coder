 ...
 *
 * When WALIA_CODER_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'WALIA_CODER_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  ...
  'WALIA_CODER_SKIP_BEDROCK_AUTH',
  'WALIA_CODER_SKIP_VERTEX_AUTH',
  'WALIA_CODER_SKIP_FOUNDRY_AUTH',
...
export const SAFE_ENV_VARS = new Set([
  ...
  'WALIA_CODER_API_KEY_HELPER_TTL_MS',
  'WALIA_CODER_DISABLE_EXPERIMENTAL_BETAS',
  'WALIA_CODER_DISABLE_NONESSENTIAL_TRAFFIC',
  'WALIA_CODER_DISABLE_TERMINAL_TITLE',
  'WALIA_CODER_ENABLE_TELEMETRY',
  'WALIA_CODER_EXPERIMENTAL_AGENT_TEAMS',
  'WALIA_CODER_IDE_SKIP_AUTO_INSTALL',
