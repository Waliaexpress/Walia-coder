 ...
 * variables instead: WALIA_CODER_AGENT_ID, WALIA_CODER_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from WALIA_CODER_PARENT_SESSION_ID env var), undefined for main REPL subagents */
